  ...
  <div class="dashboard">
    ...
    <el-card class="panel">
      ...
      <el-table :data="recent" border size="small">
        ...
        <el-table-column prop="task_name" label="任务" min-width="40" show-overflow-tooltip />
        ...
        <el-table-column prop="started_at" label="时间" min-width="120" show-overflow-tooltip />
      </el-table>
    </el-card>
  </div>
</template>

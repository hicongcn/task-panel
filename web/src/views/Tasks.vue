<template>
  <div>
    ...
    <el-table :data="tasks" v-loading="loading" border stripe @selection-change="onSelection">
      ...
      <el-table-column prop="command" label="脚本" min-width="60" show-overflow-tooltip />
      <el-table-column prop="cron_expression" label="Cron" min-width="70" show-overflow-tooltip />
